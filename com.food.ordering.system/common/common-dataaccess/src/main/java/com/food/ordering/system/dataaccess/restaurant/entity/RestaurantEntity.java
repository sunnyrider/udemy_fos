...
public class RestaurantEntity {
	...
	private RestaurantEntity(Builder builder) {
		...
		productAvailable = builder.productAvailable;
	}
	...
	public void setProductAvailable(Boolean vNewVal) {
		productAvailable = vNewVal;
	}
	...
	public String toString() {
		return "RestaurantEntity [restaurantId=" + restaurantId + ", productId=" + productId + ", restaurantName="
				...
				+ ", productPrice=" + productPrice + ", productAvailable=" + productAvailable + "]";
	}
	...
	public static final class Builder {
		...
		public Builder productAvailable(Boolean prodAvailable) {
