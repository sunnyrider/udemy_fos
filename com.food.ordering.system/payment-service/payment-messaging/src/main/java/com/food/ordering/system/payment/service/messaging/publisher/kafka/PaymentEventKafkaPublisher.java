...
public class PaymentEventKafkaPublisher implements PaymentResponseMessagePublisher {
	private static final Logger LOGGER = LoggerFactory.getLogger(PaymentEventKafkaPublisher.class);
    ...
    public void publish(OrderOutboxMessage orderOutboxMessage,
        ...
        try {
            ...
            LOGGER.info("PaymentResponseAvroModel sent to kafka for order id: {} and saga id: {}",
