...
public class OrderApprovalEventKafkaPublisher implements RestaurantApprovalRequestMessagePublisher {
	private static final Logger LOGGER = LoggerFactory.getLogger(OrderApprovalEventKafkaPublisher.class);
    ...
    public void publish(OrderApprovalOutboxMessage orderApprovalOutboxMessage,
        ...
        LOGGER.info("Received OrderApprovalOutboxMessage for order id: {} and saga id: {}",
        ...
        try {
            ...
            LOGGER.info("OrderApprovalEventPayload sent to kafka for order id: {} and saga id: {}",
                    restaurantApprovalRequestAvroModel.getOrderId(), sagaId);
        } catch (Exception e) {
            LOGGER.error("Error while sending OrderApprovalEventPayload to kafka for order id: {} and saga id: {}," +
