...
public class RestaurantApprovalRequestKafkaListener implements KafkaConsumer<RestaurantApprovalRequestAvroModel> {
	private static final Logger LOGGER = LoggerFactory.getLogger(RestaurantApprovalRequestKafkaListener.class);
    ...
    public void receive(@Payload List<RestaurantApprovalRequestAvroModel> messages,
        ...
        LOGGER.info("{} number of orders approval requests received with keys {}, partitions {} and offsets {}" +
        ...
        messages.forEach(restaurantApprovalRequestAvroModel -> {
            try {
                LOGGER.info("Processing order approval for order id: {}", restaurantApprovalRequestAvroModel.getOrderId());
                ...
                if (sqlException != null && sqlException.getSQLState() != null &&
                    ...
                    LOGGER.error("Caught unique constraint exception with sql state: {} " +
                ...
                LOGGER.error("No restaurant found for restaurant id: {}, and order id: {}",
